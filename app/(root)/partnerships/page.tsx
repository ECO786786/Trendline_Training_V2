    ...
    <section className="py-24 px-6 bg-[#f6f6f8] border-b border-gray-100">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="order-2">
          ...
          <p className="text-lg text-slate-600 mb-6 leading-relaxed">
            We are proud to partner with the Zambian Institute of Marketing
            (ZIM) to deliver accredited marketing training and professional
            development programs that align with national standards and industry
            best practices.
          </p>
          <ul className="space-y-4 mb-8">
            {[
    ...
    <section className="py-24 px-6 bg-white border-b border-gray-100">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="order-2 lg:order-1">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-slate-900">
            Kwame Nkrumah HR Chapter
          </h2>
          <p className="text-lg text-slate-600 mb-6 leading-relaxed">
            The Kwame Nkrumah HR Chapter is a flagship academic and professional
            partnership dedicated to the advancement of human resource
            management. As a standalone initiative, it serves as a centre for
            excellence—bringing together academic rigour and industry practice
            to deliver high-impact learning experiences. The Chapter provides a
            structured, university-level environment where participants develop
            strategic insight, leadership capability, and applied expertise to
            operate effectively within an evolving workforce landscape.
          </p>
          <ul className="space-y-4 mb-8">
            {[
              "A recognised HR Chapter fostering academic and professional excellence.",
              "Programmes designed to bridge theory with real-world HR practice.",
              "A platform for leadership development, collaboration, and industry engagement.",
            ].map((item) => (
              <li key={item} className="flex items-start">
                <span className="material-icons text-[#1e3b8a] mr-3 mt-1">
                  check_circle
        ...
        <div className="order-1 lg:order-2">
          <Image
            src="/images/kwame-nkuruma-hr-chapter.jpg"
            alt="HR Chapter Launch with Kwame Nkuruma"
            width={800}
            height={600}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {whyItems.map(({ icon, title, desc }) => (
            <div
              key={title}
              className="bg-[#ffffff] p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow"
            >
