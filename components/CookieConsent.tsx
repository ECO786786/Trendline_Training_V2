      ...
      <div className="fixed bottom-4 left-4 z-50 max-w-sm bg-white rounded-lg shadow-2xl border border-gray-200 p-6 animate-slide-up">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-4">
          <button
            ...
            className="flex-1 px-4 py-2.5 bg-[#1e3a8a] text-white font-medium rounded-md hover:bg-blue-900 transition-colors focus:outline-none focus:ring-2 focus:ring-[#1e3a8a] focus:ring-offset-2"
          >
            Accept All
          </button>
          <button
            onClick={handleDecline}
            className="flex-1 px-4 py-2.5 bg-white text-gray-700 font-medium rounded-md border border-gray-300 hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2"
          >
            Decline
          </button>
        </div>
