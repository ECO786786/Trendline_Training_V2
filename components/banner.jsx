      ...
      <div className="text-center max-w-[1024px] mx-auto">
        ...
        <div className="mt-6 flex items-center justify-center gap-4 md:mt-8">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center px-6 py-2 rounded-full border border-border-primary font-medium hover:bg-blue-950 transition-colors fully-rounded"
          >
            Book Appointment
          </Link>
        </div>
